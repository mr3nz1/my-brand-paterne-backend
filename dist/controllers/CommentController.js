...
class CommentController {
    ...
    getComments(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const comments = yield CommentModel_1.default.find({ articleId }).sort({
                createdAt: -1,
            });
    ...
    deleteComment(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!comment)
                throw new CustomError_1.default("There is not comment with Id: " + commentId, http_status_codes_1.StatusCodes.NOT_FOUND);
            comment.deleteOne();
            res.status(http_status_codes_1.StatusCodes.OK).json({
                status: "success",
                data: null,
