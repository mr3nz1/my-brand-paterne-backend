...
router
    ...
    .post(auth_1.default, fileUpload_1.default.single("bannerImage"), (0, asyncHandler_1.default)(ArticleController_1.default.createArticle));
router
    .route("/:id")
    .get(auth_1.default, (0, asyncHandler_1.default)(ArticleController_1.default.getArticle))
